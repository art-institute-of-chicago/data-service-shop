...
class ImportProducts extends BaseCommand
{
    ...
    public function handle()
    {
        ...
        foreach($records as $datum) {
            ...
            $product->min_compare_at_price = (float) ($datum['min_compare_at_price']);
            $product->max_compare_at_price = (float) ($datum['max_compare_at_price']);
            $product->min_current_price = (float) ($datum['min_current_price']);
            $product->max_current_price = (float) ($datum['max_current_price']);
